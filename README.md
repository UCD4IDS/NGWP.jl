...
See [`test/paperscript`](https://github.com/UCD4IDS/NGWP.jl/tree/master/test/paperscript) and [`dissertation/scripts`](https://github.com/UCD4IDS/NGWP.jl/tree/master/dissertation/scripts).
